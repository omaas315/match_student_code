...
class PubJacobian(object):
    ...
    def __init__(self, dim=(6,6)):
        ...
        self.group = moveit_commander.MoveGroupCommander("UR16e_arm")
        rospy.Subscriber('/robot1/joint_states', JointState, self.joint_states_cb)
        self.pub_jacobi = rospy.Publisher("/robot1/jacobian", Float64MultiArray, queue_size=10)
...
if __name__ == "__main__":
    rospy.init_node("pub_jacobian_urR1")
    jac = PubJacobian()
    rospy.spin()