...
class inv_diff_kinematics():
    ...
    def __init__(self):
        rospy.init_node("robot2_trajectory")
        ...
        rospy.Subscriber("/robot2/joint_states", JointState, self.cb_joint_states)
        rospy.Subscriber('/robot2/jacobian', Float64MultiArray, self.cb_jacobi)
        rospy.Subscriber('/robot2/TCP_robot2', Float64MultiArray, self.cb_tcp)
        ...
        self.pub_vel_acc_rot = rospy.Publisher("/robot2/vel_acc_rot", Float64MultiArray, queue_size=10)
        self.run()
    ...
    def run(self):
        ...
        while not rospy.is_shutdown() and time.time() < timeout:
            ...
            if self.current_time <= self.duration:
                ...
                if self.z==0:
                    rospy.wait_for_message("/robot2/TCP_robot2", Float64MultiArray)
