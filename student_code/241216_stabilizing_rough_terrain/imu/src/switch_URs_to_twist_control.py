...
UR_prefix = rospy.get_param('~UR_prefix', ['UR10_r']), #'UR10_r'])
...
for robot_name in robot_names:
    ...
    switch_controller_request.start_controllers = ['joint_group_vel_controller_r/unsafe']#, 'joint_group_vel_controller_r/unsafe']
    switch_controller_request.stop_controllers = ['UR10_r'+'/arm_controller']
