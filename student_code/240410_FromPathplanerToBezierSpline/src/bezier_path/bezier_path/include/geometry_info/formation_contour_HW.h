...
#include <geometry_info/edge_info_HW.h>
#include <geometry_info/geometry_contour_HW.h>
#include <geometry_info/minimal_enclosing_circle_HW.h>
#include <geometry_info/robot_contour_HW.h>
