...
#include <splined_relaxed_a_star/path_planner_types.h>
...
{
class SplinedRelaxedAStar : public nav_core::BaseGlobalPlanner
{
public:
    /**
...
private:
    ...
    void initVisuHelper(std::string topic_prefix, std::string g_score_marker_identificator,
    ...
    // //! This image: http://wiki.ros.org/costmap_2d?action=AttachFile&do=get&target=costmapspec.png explains the cell
    // cost values.
    ...
    // //! This value will also be checked when the formation shape is known and the minimal radius of a curve will be
    // calculated.
